...
;;; Code:
 ...
 (let ((class '((class color) (min-colors 89)))
   ...
   'beton
        ...
        `(font-lock-builtin-face ((,class (:foreground ,dark-teal))))
        `(font-lock-comment-face ((,class (:italic t :underline t :foreground ,red))))
	`(font-lock-negation-char-face ((,class (:foreground ,dark-yellow))))
	`(font-lock-reference-face ((,class (:foreground ,dark-yellow))))
	`(font-lock-constant-face ((,class (:foreground ,dark-yellow))))
        `(font-lock-doc-face ((,class (:foreground ,red))))
        `(font-lock-function-name-face ((,class (:foreground ,dark-blue ))))
        `(font-lock-keyword-face ((,class (:bold ,class :foreground ,keyword))))
        `(font-lock-string-face ((,class (:foreground ,green))))
        `(font-lock-type-face ((,class (:foreground ,dark-purple ))))
	...
	`(cursor ((,class (:background ,cursor :invert-video t))))
	...
	`(org-hide ((,class (:foreground ,fg4))))
        ...
        `(org-link ((,class (:underline t :foreground ,dark-purple ))))
        `(org-special-keyword ((,class (:foreground ,dark-blue))))
	...
	`(eshell-prompt ((,class (:bold t :foreground ,fg1))))
        ...
        `(web-mode-html-attr-name-face ((,class (:foreground ,dark-blue))))
